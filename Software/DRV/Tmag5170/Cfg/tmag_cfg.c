...
Tmag_Config_t Tmag_Config[TMAG_SENSOR_NBR_MAX] = 
{
    /* SENSOR 0 */
    {
        ...
        .device.field.mag_tempco = TMAG_MAG_TEMPCO_0_00_DEG,
        .device.field.conv_avg = TMAG_MAG_CONV_AVG_4X,
        ...
        .mag_gain.field.gain_value = 452U,
    ...
    /* SENSOR 1 */
    {
        ...
        /* MAG_GAIN_CONFIG */
        .mag_gain.field.gain_selection = TMAG_GAIN_SELECTION_Y,
        .mag_gain.field.gain_value = 965U,
